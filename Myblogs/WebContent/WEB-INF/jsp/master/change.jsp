	...
	<body class="single is-preload">
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
				<form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/master/savetext_2.action" >
					<div id="main">
						<!-- Post -->
							<article class="post">
							<input type="text" style="background:#f4f4f4; border:0px; padding:0em; display: none;" name="id" value="${art.id}"/>
								<header>
									<div class="title" style="padding: 2em 3em 2.5em 3em; ">
										<h2><input type="text" name="title" style="font-size:25px; background: #ffffff; border:0px; text-align:center;" value="${art.title}"></h2>
										<p><input type="text" name="intro" style="font-size:15px; background: #ffffff; border:0px; text-align:center;" value="${art.intro}"></p>
									</div>
									<div class="meta">
										<time class="published" style="font-family:Sans-serif; font-size:1em;">${art.tti}</time>
										<input type="text" style="display:none;">
										<a href="#" class="author"><span class="name">${art.name}</span><img src="${pageContext.request.contextPath}${art.photo_u}" alt="" /></a>
										<input type="text" style="display:none;">
										
									</div>
								</header>
								<span class="image featured" onclick="binding()"><img id="pho" src="${pageContext.request.contextPath}${art.photo}" alt="" /></span>
								<input type="file" id="file" name="photo2" onchange="show(this)" multiple="multiple" style="display:none;">
								<textarea id="textarea" style="min-height:300px;">${art.txt}</textarea>
